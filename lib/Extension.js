!function() {
    ...
    module.exports = new Class({
        ...
        , onBeforePrepare: function(resource, definition) {
            ...
            // ORDER STATEMENT
            thisContext.prepareOrder(resource, definition);
        }
        ...
        , prepareOrder: function(resource, definition) {
            ...
            if (groupAdded) {
                this._addGroupBy(resource.query.from, definition.primaryKeys, resource);
            }
        }
        ...
        , useOnModel: function(definition) {
            ...
            if (Object.keys(definition.columns).filter(function(columnName) {
                return !this.blacklist || !this.blacklist.length || this.blacklist.indexOf(columnName) === -1;
            }.bind(this)).some(function(columnName) {
                ...
                // need this for localized language tables
